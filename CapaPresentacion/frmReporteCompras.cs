            ...
            if (dgvdata.Rows.Count < 1)
            {
                ...
                if (savefile.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        MessageBox.Show("Compra Generado", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);

                    }
                    catch
                    {
                        MessageBox.Show("Error al generar la compra", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
